					...
					<div id="slider">
						...
						<ul>
							<li>
								...
								<div class="caption">
									<h2><a title= "Welcome to the London Hair Company" href="home.php"><u>Welcome to the London Hair Company.</u></a></h2>
							...
							<li>
								...
								<div class="caption">
									<h2><a title="For our new customers" href="home.php">For our new customers</a></h2>
