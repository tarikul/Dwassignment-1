...
@$con=mysql_connect("localhost","root","") or die("Database Error");
	$query="drop database if exists globalstyling";	
	...
	$query="create database globalstyling";
	$result=mysql_query($query,$con);
		if($result==false){
			echo mysql_error();
		}
		 ...
		 // select the globalstyling database;
	mysql_select_db('globalstyling');
 ...
 $query="INSERT INTO appointment (appoint_id, username, person, country, date, time, product_id) VALUES
...
";
 ...
 if($result==false){
	 ...
	 echo " Appointment Data Inserted<br/>";
 }
//-----------------------------------Log In Table Created--------
$query="CREATE TABLE IF NOT EXISTS login (
 ...
 if($result==false){
	 ...
	 echo " Log In table Created<br/>";
 } 
$query="INSERT INTO login (id, username, password) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3')";
 ...
 if($result==false){
	 ...
	 echo " Log In table Data Inserted<br/>";
 }
 //--------------------- Registration----------------
$query="CREATE TABLE IF NOT EXISTS registration (
 ...
 $query="INSERT INTO registration (id, username, email, password, age, biography, person, country) VALUES
...
(13, 'sdfds', 'admin@gmail.com', '3d4044d65abdda407a92991f1300ec97', 'under_13', 'dfgdfg', 'Women', 'NewYork')";
 ...
 if($result==false){
	 ...
	 echo " Registration table Data Inserted<br/>";
 }
//-------------------------product -------------------
...
(21, 'Men', 'HAIRSTYLE', 'Men in this picture had very rough messy long hairs which also dye in a brown blonde mix shade. It’s a very attractive and unique hairstyle of this year.', 0x3130312e6a7067, 129, 'london'),
...
(29, 'Women', 'Hairtreatm', 'In 2013, the best trendy hair cut for men’s is the half-shaved style. Half shaved is best for these summers and also very easy to handle or carry anywhere. It is also a very trendy style among boys.', 0x7468756d62322e6a7067, 45, 'London'),
(30, 'Women', 'Hairstyle', 'You coordinate statement sunglasses with a combination of lipstick and gloss. It is smart, sassy and we tell you-very powerful. Go for lip duos like Noni Crème Colour Classic Lip Duo to ramp up that look every now and then. ', 0x3230332e6a7067, 45, 'London'),
...
(32, 'Men', 'Hairtreatm', ' You coordinate statement sunglasses with a combination of lipstick and gloss. It is smart, sassy and we tell you-very powerful. Go for lip duos like Noni Crème Colour Classic Lip Duo to ramp up that look every now and then. Don’t forget to carry that smile and please groom your eyebrows!', 0x3130312e6a7067, 26, 'Paris'),
(33, 'Men', 'Haircurt', 'You coordinate statement sunglasses with a combination of lipstick and gloss. It is smart, sassy and we tell you-very powerful. Go for lip duos like Noni Crème Colour Classic Lip Duo to ramp up that look every now and then. ', 0x3130322e6a7067, 65, 'Paris'),
(35, 'Men', 'Haircurt', ' You coordinate statement sunglasses with a combination of lipstick and gloss. It is smart, sassy and we tell you-very powerful. Go for lip duos like Noni Crème Colour Classic Lip Duo to ramp up that look every now and then. Don’t forget to carry that smile and please groom your eyebrows!', 0x3130312e6a7067, 16, 'Newyork'),
(36, 'Women', 'Hairsampoo', 'You coordinate statement sunglasses with a combination of lipstick and gloss. It is smart, sassy and we tell you-very powerful. Go for lip duos like Noni Crème Colour Classic Lip Duo to ramp up that look every now and then. ', 0x7468756d62332e6a7067, 98, 'Newyork'),
...
(42, 'Men', 'Haircurt', 'Following the footsteps of many celebrities, renowned models and influential media personalities, millions of new-generation fashionistas are getting smitten by the incredible benefits of artificial hair extension these days. Incredible popularity of artificial.', 0x3130322e6a7067, 45, 'Newyork')";
 ...
 if($result==false){
	 ...
	 echo " Inserted product Table<br/>";
 } 
?>